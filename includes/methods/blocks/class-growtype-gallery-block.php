...
//            dd($block_content);
            ...
            $sliderActive = $parsed_block["attrs"]['sliderActive'] ?? false;
            $sliderSlidesAmountToShow = $parsed_block["attrs"]['sliderSlidesAmountToShow'] ?? '4';
            $loaderActive = $parsed_block["attrs"]['loaderActive'] ?? false;
            $loaderType = $parsed_block["attrs"]['loaderType'] ?? '';
            ...
            ?>
            <div class="growtype-gallery-wrapper <?php echo $sliderActive ? 'slider-active' : '' ?> <?php echo $loaderActive ? 'loader-active' : '' ?>"
                 data-slides-amount-to-show="<?php echo $sliderSlidesAmountToShow ?>"
                 data-loader-type="<?php echo $loaderType ?>"
            >
